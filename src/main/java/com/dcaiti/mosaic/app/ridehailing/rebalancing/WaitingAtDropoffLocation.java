...
public class WaitingAtDropoffLocation extends ConfigurableApplication<CVehicleApp, VehicleOperatingSystem> implements VehicleApplication {
    ...
    public WaitingAtDropoffLocation() {
