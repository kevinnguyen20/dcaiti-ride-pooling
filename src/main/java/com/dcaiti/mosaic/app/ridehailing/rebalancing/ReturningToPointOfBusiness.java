...
public class ReturningToPointOfBusiness extends ConfigurableApplication<CVehicleApp, VehicleOperatingSystem> implements VehicleApplication {
    ...
    public ReturningToPointOfBusiness() {
