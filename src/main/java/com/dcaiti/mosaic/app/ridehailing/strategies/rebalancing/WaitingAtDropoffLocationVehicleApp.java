...
public class WaitingAtDropoffLocationVehicleApp extends ConfigurableApplication<CVehicleApp, VehicleOperatingSystem> implements VehicleApplication {
    ...
    public WaitingAtDropoffLocationVehicleApp() {
